...
| Native Engineer + bounded local GPU delegation | WORKER-005: Qwen3.5 produced two contract-failing artifacts under the two-call cap; no integration | LOCAL_GPU_DELEGATION_REJECTED |
